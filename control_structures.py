...
---
    ...
    cwd = "./control_structure/"
    if genre == "making decisions":
        control_structures_general(cwd+"making_decisions/")
    elif genre == "looping":
        control_structures_general(cwd+"looping/")
        

def control_structures_general(cwd):
    ...
    if submit_button:
        ...
        completion = client.chat.completions.create(
          model="gpt-4o",
          messages=[
            {"role": "system", "content": "You are an experienced Java instructor. Please provide Java code as your solution if necessary. Do not use lists, trees, and hashmaps in your solution."},
